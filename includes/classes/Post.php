	...
	public function submitPost($body, $user_to, $imageName) {
		...
		if($check_empty != "" || $imageName != "") {
			...
			$stopWords = "a about above across after again against all almost alone along already
			 also although always among am b back backed backing backs be became
			 because  c came can cannot case cases certain certainly clear clearly come could
			 d did differ different downing downs during
			 e each  f face faces fact facts  furthers g gave general generally
			 get gets  h had has have having he her  i im if important in interest interested interesting
			 interests into is it its itself j just k keep keeps kind knew know known knows
			  m made make making n necessary need needed needing needs never
			 new new newer newest next no  o of off often old older oldest on once one only open opened opening
			 opens or order ordered ordering orders other others our out over p part parted
			  q quite r
			 rather really  s said same  sure t take
			 taken than that the their  turn turned turning turns two
			 u under until up upon us use used uses v very w want wanted wanting
			 wants  x y year years yet you young younger
			 youngest your yours z lol haha omg hey ill";
				...
				if($user_logged_obj->isFriend($added_by)){
					...
					$str .= "<div class='status_post' onClick='javascript:toggle$id(event)'>
								...
								<div class='newsfeedPostOptions'>
									<i class='far fa-comment'></i>($comments_check_num)&nbsp;&nbsp;&nbsp;
